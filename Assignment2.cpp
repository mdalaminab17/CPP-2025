...
class SavingAccount: public Account{
    ...
    SavingAccount(string n, string t, int a):Account(n,t,a){}
    void get() {
...
class CurrentAccount: public Account{
    ...
    CurrentAccount(string n, string t, int a):Account(n,t,a)
    {
...
int main()
{
    SavingAccount s1("Ali", "Saving", 12345);
    s1.get();
    CurrentAccount c1("Md Al Amin", "Current", 242311049);
    c1.get();
